 {%–– Source https://github.com/chihacknight/chihacknight.org/blob/master/breakouts.html %}
...
<div class="collapse" id="collapseExample">
  <div class="well">
    <ol>
      ...
      <li>Open a new GitHub Issue in this repository: <a href='https://github.com/codeformilwaukee/breakout-groups/issues/new' target='_blank'>https://github.com/codeformilwaukee/join-a-breakout/issues/new</a></li>
...
<script>
  ...
  $.when( $.getJSON( "https://api.github.com/repos/codeformilwaukee/breakout-groups/issues?state=open&direction=asc" ) ).then(function( data, textStatus, jqXHR ) {
